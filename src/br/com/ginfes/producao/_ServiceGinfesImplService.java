...
public class _ServiceGinfesImplService extends Service
{

    public _ServiceGinfesImplService()
    {
...
//    }
    ...
    public _ServiceGinfesImplService(URL wsdlLocation)
    {
...
//    }
    ...
    public _ServiceGinfesImplService(URL wsdlLocation, QName serviceName)
    {
...
//    }
    ...
    public _ServiceGinfesImpl getServiceGinfesImplPort()
    {
    	return (_ServiceGinfesImpl)super.getPort(new QName("http://producao.ginfes.com.br", "ServiceGinfesImplPort"), br.com.ginfes.producao._ServiceGinfesImpl.class);
    }
